 ...
 * |------+------+------+------+------+-------+------+------+------+------+------+------|
 * | Brite| Ctrl | Alt  | GUI  |Lower |SPC_NUM| ESC  |Raise | Left | Down |  Up  |      |
 * `------------------------------------------------------------------------------------'
 */
[_COLEMAK] = LAYOUT_planck_grid(
    ...
    BACKLIT, KC_LCTL, KC_LALT, KC_LGUI, LOWER,  SPC_NUM, ESC_SYM, RAISE,  KC_LEFT, KC_DOWN, KC_UP, _______
),
...
[_SYMBOLS] = LAYOUT_planck_grid(
    KC_PERC, KC_CIRC, KC_AMPR, KC_ASTR, KC_LCBR, KC_RCBR, _______, _______, _______, _______, _______, _______,
    KC_UNDS, KC_MINS, KC_PLUS, KC_EQL,  KC_LPRN, KC_RPRN, _______, _______, _______, _______, _______, _______,
    KC_AT,   KC_HASH, KC_EXLM, KC_DLR,  KC_LBRC, KC_RBRC, _______, _______, _______, _______, _______, _______,
    _______, KC_PIPE, KC_BSLS, KC_TILD, KC_GRV,  _______, _______, _______, _______, _______, _______, _______
),
